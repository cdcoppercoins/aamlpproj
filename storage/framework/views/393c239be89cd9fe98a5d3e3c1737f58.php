<?php $__env->startSection('title', 'About | MiniLicensePlates.com'); ?>
...
<div class="set-width">
    ...
    <p>
        ...
        collections to bring the site to the point it is now, and would appreciate your help. Use the <a href="<?php echo e(route('contribute')); ?>">contribution form</a>
    ...
    <h2>Contact</h2>
    <p>
        Email: <a href="<?php echo e(route('contribute')); ?>">contact form</a><br>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\aamlpproj\resources\views/about.blade.php ENDPATH**/ ?>